...
module OmfEc
  ...
  class Experiment
    ...
    attr_accessor :name, :sliceID, :oml_uri, :js_url, :ss_url, :job_url, :job_mps, :app_definitions, :property, :cmdline_properties, :show_graph, :nodes, :assertion, :vms, :federate, :domain
      ...
      def done(done_vms=false)
        ...
        OmfCommon.el.after(10) do
          ...
          OmfCommon.el.after(4) do
            ...
            OmfCommon.el.after(1) do
              OmfCommon.comm.disconnect({:delete => true, :release_childs => done_vms})
